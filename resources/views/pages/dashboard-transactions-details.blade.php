                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="product-subtitle">
                                                    {{ $transaction->created_at->format('d F Y') }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="product-subtitle">
                                                    ${{ number_format($transaction->transaction->total) }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="product-title">Mobile</div>
                                                <div class="product-subtitle">{{ $transaction->transaction->user->mobile }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="product-subtitle">
                                                        {{ $transaction->transaction->user->zipCode }}</div>
                                                </div>
                                                <div class="col-12 col-md-6">
...
@push('addon-script')
    ...
    <script>
        var transcationDetails = new Vue({
